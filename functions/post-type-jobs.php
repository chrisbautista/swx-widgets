...
function tz_jobs_list($atts, $content) {
	...
	if ( $custom_posts->have_posts() ) {
		...
		echo('
				...
				<!-- Hear From Staff -->
				<div class="section-dark-gray-colored">
					<div class="container">
						<div class="row">
							<div class="col-sm-9"><h2>Hear From Staff</h2></div>
							<div class="col-sm-3"><h4 style="margin-top:25px;">More from Staff <span class="glyphicon glyphicon-play"></span></h4></div>
						</div>	
						 <div class="row">            
							<div class="col-sm-4">
								<div class="hear-from-staff">
									<ul>
										<li><img class="img-responsive" src="http://placehold.it/410x250/cccccc/ffffff/"></li>
										<li class="desc">
											<h4>John Smith</h4>
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc placerat diam quis nisl vestibulum dignissim.</p>
										</li>		                		
									</ul>
								</div>		             
							</div> 
