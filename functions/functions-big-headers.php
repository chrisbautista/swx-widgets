...
if (isset($post)){ 
	...
	$meta_shortcode = $custom["big_header_shortcode"][0];
...
$custom_meta_fields = array(  
    array(  
        'label'=> 'Instructions:',  
        'desc'  => 'Use Wordpress\'s "Featured Image" functionality to specify a picture. The following options allow you to override that functionality with a block of custom code, to embed a slider shortcode for example.',  
        'id'    => $prefix.'intro',  
        'type'  => 'description'  
    ),  
    array(  
        'label'=> 'Override Featured Image with Shortcode ',  
        'desc'  => '(Optional) Specify a shortcode like a slider instead.',  
        'id'    => $prefix.'shortcode',  
        'type'  => 'text',  
    ),  
    array(  
        'label'=> 'Override Featured Image ',  
        'desc'  => '(Optional) Specify HTML code that will be published INSTEAD of the featured image.',  
        'id'    => $prefix.'big_box',  
        'type'  => 'textarea'  
    ),  
    array(  
        'label'=> 'Homepage Image URL  ',  
        'desc'  => '(Optional) Specify a custom image for the homepage? Include http://',  
        'id'    => $prefix.'image',  
        'type'  => 'text',  
    ),  
 );  
