...
<form id="<?php echo $id; ?>" class="dm-form validator autofill no-free-email phone-validator quote" action="<?php echo $form_url; ?>" method="post" accept-charset="UTF-8">
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12">
		<h3>Request a Free Trial:</h3>Unsure whether Dynamics Stratus is right for you? Try it out risk free with a 30 day trial! Complete the form and a BDO Solutions representative  will contact you shortly.<br><br>
	</div>
</div>
	<div class="row">
		<div class="col-lg-4 col-md-4 col-sm-4">
			<p>
				...
				<input type="text" onchange="" maxlength="255" size="30" class="text" value="" id="Email" name="Email">
			</p><br>
			<p>      
				<label for="Company_Name" class="field-label"  >Company Name </label><br>
				<input type="text" onchange="" maxlength="32" size="30" class="text" value="" id="Company_Name" name="Company_Name" > 
			</p>
		</div>
		<div class="col-lg-4 col-md-4 col-sm-4">
			<p>      
				<label for="First_Name" class="field-label"  >First Name </label><br>
				<input type="text" onchange="" maxlength="32" size="30" class="text" value="" id="First_Name" name="First_Name" > <br><br>
			</p>
			<p>      
				<label for="Last_Name" class="field-label"  >Last Name </label><br>
				<input type="text" onchange="" maxlength="32" size="30" class="text" value="" id="Last_Name" name="Last_Name" > 
			</p>
		</div>
		<div class="col-lg-4 col-md-4 col-sm-4">
			<p>
				...
				<br>
				<input type="text" onchange="" maxlength="32" size="30" class="text" value="" id="Phone" name="Phone"> 
			</p>
		</div>
	</div>
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-8">
			...
			<br>
				...
				<br>
				<textarea name="Comments" id="Comments" onchange="" cols="85" rows="6" class="standard"></textarea>
			</p>
		</div>
		<div class="col-lg-4 col-md-4 col-sm-4">
			<p class="mrkt-comms">
			...
			<p class="submit">
				<input type="submit" class="btn btn-primary btn-large btn-contact" accesskey="s" value="Request Quote &gt;&gt;">
			</p>
		</div>
	</div>
</form>
