		...
		?>
			  <?php echo $before_widget; ?>
				  <?php if ( $title ) { echo $before_title . $title . $after_title; } ?>
						<ul>
							<li><a href="http://www.randgroup.com/software/<?php echo $product_link; ?>" title="<?php echo $cat_parent_name; ?> Consultants in Dallas &amp; Houston, TX"><?php echo $cat_parent_name; ?> Consultants</a></li>
...
function context_link($atts, $content = null) {  
    extract(shortcode_atts(array(  
		...
		*/
		...
		$output = 'Need More Info?<br/><a href="http://www.randgroup.com/software/'.$product_link.'" title="'.$cat_parent_name.' Consultants in Dallas &amp; Houston, TX">Speak to a '.$cat_parent_name.' Consultant </a>';
	return $output;	
